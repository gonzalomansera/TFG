...
export const Trayectoria = () => {
  return (
    <section id="recorrido" className="py-32 bg-[#2a2a2a] text-white">
          ...
          <div className="w-full lg:w-2/5 lg:sticky lg:top-32">
            <div className="relative group">
              ...
              <div className="mt-8 space-y-4">
                ...
                <p className="text-gray-500 text-xs tracking-[0.3em] uppercase">Artista Multidisciplinar</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative border-l border-white/5 pl-8 space-y-16">
              {hitos.map((hito, index) => (
                <div key={index} className="relative group">
                  <div className="absolute -left-[37px] top-0 w-[11px] h-[11px] rounded-full bg-[#2a2a2a] border border-[#E08733] group-hover:bg-[#E08733] transition-colors duration-300"></div>
                  
                  <div className="space-y-3">
                    <span className="text-[#E08733] font-mono text-xs tracking-tighter opacity-60">
                      {hito.fecha}
                    </span>
                    <h3 className="text-lg font-bold uppercase tracking-widest text-white/90 group-hover:text-[#E08733] transition-colors">
                      {hito.titulo}
                    </h3>
                    <p className="text-gray-400 text-sm leading-relaxed max-w-lg font-light">
                      {hito.descripcion}
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-12 border-t border-white/5">
                <div className="flex items-center gap-4 text-[#E08733]">
                  <MapPin size={18} />
                  <span className="text-[10px] font-bold uppercase tracking-[0.4em]">Born Again Tattoo, Granada</span>
                </div>
              </div>
            </div>
          </div>
